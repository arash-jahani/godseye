    ...
    (async () => {
        try {
            ...
            globItems.forEach(globItem => {
                ...
                if (foundItem === undefined|| foundItem.symbol==="MIR/USDT"|| foundItem.symbol==="FTT/USDT" || foundItem.symbol==="BTT/USDT"|| foundItem.symbol==="GMT/USDT"|| foundItem.symbol==="SRM/USDT") {
                    return
                }
