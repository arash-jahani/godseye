    ...
    (async () => {
        try {
            ...
            globItems.forEach(globItem => {
                ...
                if (foundItem === undefined||foundItem.s==="SRM-USDT" || foundItem.s==="FTT-USDT" || foundItem.s==="CRV-USDT"||foundItem.s==="BTT-USDT"|| foundItem.s==="MIR-USDT"|| foundItem.s==="PLA-USDT"|| foundItem.s==="UNFI-USDT"|| foundItem.s==="GMT-USDT"|| foundItem.s==="BURGER-USDT") {
                    return
                }
