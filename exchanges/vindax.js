    ...
    (async () => {
        try {
            ...
            globItems.forEach(globItem => {
                ...
                if (foundItem === undefined || foundItem.symbol==="MIRUSDT" || foundItem.symbol==="SRMUSDT"   || foundItem.symbol==="RLCUSDT"|| foundItem.symbol==="BELUSDT" || foundItem.symbol==="BTT/USDT" || foundItem.symbol==="PNTUSDT"
                || foundItem.symbol==="FTMUSDT"  || foundItem.symbol==="TLMUSDT" || foundItem.symbol==="FTTUSDT") {
                    return
                }
