    ...
    (async () => {
        try {
            ...
            globItems.forEach(globItem => {
                ...
                if (foundItem === undefined || foundItem.symbol==="DNT/USDT" ||foundItem.symbol==="GAL/USDT" ||foundItem.symbol==="BTT/USDT" || foundItem.symbol==="BULL/USDT" || foundItem.symbol==="GMT/USDT"|| foundItem.symbol==="EPS/USDT") {
                    return
                }
