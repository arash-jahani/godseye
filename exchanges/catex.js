    ...
    (async () => {
        try {
            ...
            globItems.forEach(globItem => {
                ...
                if (foundItem === undefined || foundItem.symbol==="MIR/USDT" || foundItem.symbol==="SRM/USDT" || foundItem.symbol==="ATM/USDT" || foundItem.symbol==="BTT/USDT"|| foundItem.symbol==="FTT/USDT") {
                    return
                }
