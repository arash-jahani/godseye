    ...
    (async () => {
        try {
            ...
            globItems.forEach(globItem => {
                ...
                if (foundItem === undefined|| foundItem.pairName==="MIR/USDT" || foundItem.pairName==="BTT/USDT"|| foundItem.pairName==="RSR/USDT"|| foundItem.pairName==="FTT/USDT" || foundItem.pairName==="SRM/USDT") {
                    return
                }
